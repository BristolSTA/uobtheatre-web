        ...
        <template v-else>
          ...
          <loading-container :loading="paying">
            ...
            <div class="grid grid-cols-2 gap-2 text-center">
              <template v-if="booking.totalPrice > 0">
                ...
                <button
                  ...
                  class="p-2 transition-colors rounded  bg-sta-green hover:bg-sta-green-dark focus:outline-none btn disabled"
            ...
            <template v-if="paymentMode == 'SQUARE_POS'" #overlay>
              <div>
                <button
                  class="p-2 mt-4 transition-colors rounded  bg-sta-rouge hover:bg-sta-rouge-dark"
